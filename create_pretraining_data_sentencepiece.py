...
def get_arguments():
    ...
    parser.add_argument("--do_lower_case", type=strtobool, default=True)
...
def write_instance_to_example_files(instances, tokenizer, max_seq_length,
    ...
    for output_file in output_files:
        ...
        writers.append(chainer.datasets.PickleDatasetWriter(open(output_file, 'wb')))
    ...
    for (inst_index, instance) in enumerate(instances):
        ...
        writers[writer_index].write(features)
